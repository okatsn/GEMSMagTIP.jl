...
DocMeta.setdocmeta!(GEMSMagTIP, :DocTestSetup, :(using GEMSMagTIP); recursive=true)

makedocs(;
    modules=[GEMSMagTIP],
    authors="okatsn <okatsn@gmail.com> and contributors",
    repo="https://github.com/okatsn/GEMSMagTIP.jl/blob/{commit}{path}#{line}",
    sitename="GEMSMagTIP.jl",
    format=Documenter.HTML(;
        prettyurls=get(ENV, "CI", "false") == "true",
        canonical="https://okatsn.github.io/GEMSMagTIP.jl",
        edit_link="main",
        assets=String[],
    ),
    pages=[
...
deploydocs(;
    repo="github.com/okatsn/GEMSMagTIP.jl",
    devbranch="main",
)
